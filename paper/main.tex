...
\title{WAIC Consistency, Posterior Concentration, and PAC-Bayes Sample Complexity
       for Bayesian Decision Trees with Catalan-Exponential Prior}

\runtitle{Bayesian Decision Trees with Catalan Prior}

\begin{aug}
\author{\fnms{Vitaly} \snm{Schetinin}%
  \ead[label=e1]{vitaly.schetinin@gmail.com}}
\address{Institute of Research in Applicable Computing,
...
code is available at \url{https://github.com/vitsch/jbdt}.
...
The author thanks Julija Jakaite for the original JBDT implementation and
